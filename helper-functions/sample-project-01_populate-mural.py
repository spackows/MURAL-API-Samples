...
def addWidgetsToMural( mural_oauth_token, mural_id, widgets_json=None, comments_df=None ):
    if widgets_json != None:
        addWidgetsToMuralJSON( mural_oauth_token, mural_id, widgets_json )
    elif comments_df != None:
        addWidgetsToMuralDF( mural_oauth_token, mural_id, comments_df )
    else:
